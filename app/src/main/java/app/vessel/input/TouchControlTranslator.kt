...
class TouchControlTranslator(
    ...
    internal companion object {
         ...
         *
         * **This was already one second once.** `3228c03` made the change; six
         * hours later `b98fe4b` reset the whole app tree to bisect a frame
         * generation regression -- black patches on RE9 -- and took this with
         * it, unmentioned, because it happened to be in the same tree. The
         * re-apply plan that followed was about the nine renderer changes, so
