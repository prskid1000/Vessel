...
class MetricSampler @Inject constructor(
    ...
    fun sample(
        ...
        return MetricSample(
            ...
            d3dGpuIdleUsPerFrame = d3d?.gpuIdleUsPerFrame,
            d3dGpuSyncUsPerFrame = d3d?.gpuSyncUsPerFrame,
            d3dCsIdleUsPerFrame = d3d?.csIdleUsPerFrame,
            d3dCsSyncUsPerFrame = d3d?.csSyncUsPerFrame,
